...
<body>
    <form action="{{route('auth.check_register_admin')}}" method="POST" class="login-box">
        @csrf
        <div class="login-header">
            <header>Register with the admin</header>
        ...
        <div class="sign-up-link">
            <p>You already have an account? <a href="{{route('auth.login_admin')}}">Sign in</a></p>
        </div>
    </form>
