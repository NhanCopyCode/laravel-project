    ...
    <div class="header-top">
      ...
      <div class="container">
        ...
        <div class="header-top-actions">
            ...
            @if (auth()->check()) 
                <div style="cursor: pointer;" class="header-top__account">
                    <p>{{auth()->user()->name}}</p>
                    <div class="action-btn btn__person-outline">
                      <ion-icon style="font-size: 26px;" name="person-outline"></ion-icon>
                      <ul class="person-outline__info-list">
                        <li class="person-outline__info-item">
                          <a href="{{route('user.profile')}}">Tài khoản của tôi</a>
                        </li>
                        <li class="person-outline__info-item">
                          <a href=""> Lịch sử thuê xe</a>
                        </li>
                        <li class="person-outline__info-item">
